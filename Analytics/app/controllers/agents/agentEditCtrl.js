...
define(['app'], function (app) {
    ...
    app.register.controller('AgentEditCtrl', ['$scope', '$routeParams', '$timeout', 'config', 'dataService', function ($scope, $routeParams, $timeout, config, dataService) {
        ...
        function init() {
            ...
            if (agentID > 0) {
                dataService.getCustomer(agentID)
